...
public enum SimpleAuth {
    public static func empty() -> SimpleAuthRef? {
    ...
    public static func acquireInteractive(
    ...
    public static func duplicateRight(
        rightName: String,
        templateName: String,
        comment: String,
        timeout: Int
    ...
    public static func removeRight(rightName: String) -> OSStatus {
        let simpleAuth = self.empty()
        guard let simpleAuth else {
            return errAuthorizationInternal
        }
    ...
    public static func toData(simpleAuth: SimpleAuthRef) -> Data? {
    ...
    public static func fromData(authData: Data) -> SimpleAuthRef? {
